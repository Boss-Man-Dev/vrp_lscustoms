...
-------Controls--------
	controls = {
		menu_up 	= 27,  --up arrow
		menu_down 	= 173, --down arrow
		menu_left 	= 174, --left arrow
		menu_right 	= 175, --right arrow
		menu_select = 201, --enter key
		menu_back 	= 177  --backspace
	},
...
-----Suv wheels------
	suvwheels = {
		...
		{name = "Speedballer",   wtype = 3, mod = 12, price = 1000},
...
-----Offroad wheels-----
	offroadwheels = {
		...
		{name = "Mudslinger", 	 wtype = 4, mod = 1,  price = 1000},
		...
		{name = "Specsteelie",   wtype = 4, mod = 9,  price = 1000},
	},
-----Tuner wheels------
	tunerwheels = {
...
-----Highend wheels------
	highendwheels = {
		...
		{name = "Carboncheetah", wtype = 7, mod = 18, price = 1000},
...
-----------Horn----------
	[14] = {
		...
		{name = "Spangled Banner 1", mod = 28, price = 11375},
		{name = "Spangled Banner 2", mod = 29, price = 11375},
		{name = "Spangled Banner 3", mod = 30, price = 11375},
		{name = "Spangled Banner 4", mod = 31, price = 11375},
		{name = "Horn Loop 1", 		 mod = 32, price = 11375},
		{name = "Horn loop 2", 		 mod = 33, price = 11375},
		{name = "Horn Loop 3", 		 mod = 34, price = 11375},
		{name = "Halloween Loop 1",  mod = 38, price = 30000},
		{name = "Halloween Loop 2",  mod = 40, price = 30000},
		{name = "San Andreas Loop",  mod = 42, price = 30000},
		{name = "Liberty City", 	 mod = 44, price = 30000},
